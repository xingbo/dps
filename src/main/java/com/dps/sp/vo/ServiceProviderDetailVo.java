...
public class ServiceProviderDetailVo {
    ...
    // one ServiceProvier must and only belongs to one single User
    private UserVo user;

    // one ServiceProvider can have one or many different ServiceTypes
    ...
    public void setAvailableServiceTypes(List<ServiceType> availableServiceTypes) {
